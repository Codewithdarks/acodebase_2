...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::get('/dashboard-chart/{type}/{from}', [DashboardController::class, 'ChartDataResponse'])->name('chart.data');
    ...
    Route::any('get/products', [BuilderController::class, 'GetStoreProducts'])->name('get.storeproduct');
