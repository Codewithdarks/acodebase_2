...
<main class="form-signin text-center">
  ...
  @csrf
  <img src="@if((new \App\Http\Controllers\SettingsController)->RetrieveValue('logo') !='') {{ (new \App\Http\Controllers\SettingsController)->RetrieveValue('logo') }}@else{{ asset('images/logo.png') }}@endif" alt="" width="200">
