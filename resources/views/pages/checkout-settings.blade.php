                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-3 mb-3">
                                            ...
                                            <script type="text/javascript">
                                                document.getElementById('delkey{{ $exist }}').addEventListener('click',function (){
                                        ...
                                        <form action="{{ route('why.update', $exist->id) }}" enctype="multipart/form-data" method="POST">@csrf
                                            ...
                                            <div class="px-4 py-4" >
                                                <div class="row">
                                                    ...
                                                    <div class="col-6">
                                                        <div class="mb-3">
                                                            <input type="text" name="title" class="form-control" placeholder="Enter Person name" value="{{ $data->title }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-6">
                                                        <div class="mb-3">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="mb-3">
                                                            <input type="text" class="form-control" id="exampleInput" name="description" placeholder="person review" value="{{ $data->description }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-3 mb-3">
                                                        <input type="submit" value="update" style="color:white;" class="btn bg-primary">
