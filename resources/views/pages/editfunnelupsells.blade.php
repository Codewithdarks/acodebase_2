        ...
        <div class="col-12 col-md-12 col-lg-6">
          <div class="product-column">
            ...
            <div class="actiongroupupdnll btn-outer mt-3 d-flex align-items-center justify-content-between"  style="visibility: hidden;">
              <button type="button" class="btn btn-lg preview-btn disabled" data-id="" data-type="">Preview</button>
              <button type="submit" id="savefunnelupdosell" class="btn btn-lg btn-success disabled">Save</button>
...
<script type="text/javascript">var SHOPIFYMAINDOMAIN = "{{ (new \App\Http\Controllers\SettingsController)->RetrieveValue('shopify_main_domain') }}";</script>
