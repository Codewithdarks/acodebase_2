...
@section('content')
    <div class="container">
        ...
        <div class="bg-white p-3 p-md-4 p-lg-5 shadow-sm">
            ...
            <div class="col-12 col-md-12 col-lg-6"><label>Shopify Website link</label>
            ...
            <div class="col-12 col-md-12 col-lg-6"><label for="header_text">Shopify Admin API Access Token</label>
            ...
            <div class="col-12 col-md-12 col-lg-6"><label for="Checkout_LOGO">Shopify Storefront API Access Token</label>
            ...
            <div class="col-12 col-md-12 col-lg-4"><label for="Checkout_LOGO">Shopify API version</label>
            ...
            <div class="col-12 col-md-12 col-lg-4"><label for="Checkout_LOGO">Shopify Currency symbol</label>
            ...
            <div class="col-12 col-md-12 col-lg-4"><labe>Avalara Username</labe>
            ...
            <div class="col-12 col-md-12 col-lg-4"><label>Avalara Password</label>
            ...
            <div class="col-12 col-md-12 col-lg-4"><label for="header_text">Avalara Company</label>
            ...
            <div class="col-12 col-md-12 col-lg-4"><label for="header_text">Avalara Account ID</label>
            ...
            <div class="col-12 col-md-12 col-lg-4"><label for="Checkout_LOGO">Avalara License Key</label>
            ...
            <div class="col-12 col-md-12 col-lg-4"><label for="Checkout_LOGO">Avalara Environment</label>
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-12 col-lg-4"><label for="Checkout_LOGO">Shipping Address</label>
                ...
                <div class="col-12 col-md-12 col-lg-4"><label for="Checkout_LOGO">Shipping Address2</label>
                ...
                <div class="col-12 col-md-12 col-lg-4"><label for="Checkout_LOGO">Shipping Address3</label>
                ...
                <div class="col-12 col-md-12 col-lg-6"> <label for="Checkout_LOGO">Shipping City</label>
                ...
                <div class="col-12 col-md-12 col-lg-6"><label for="Checkout_LOGO">Shipping State</label>
                ...
                <div class="col-12 col-md-12 col-lg-6"><label for="Checkout_LOGO">Shipping Postalcode</label>
