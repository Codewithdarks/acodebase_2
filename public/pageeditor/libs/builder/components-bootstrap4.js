...
WEO.ComponentsGroup['Bootstrap 4'] =
...
//display
WEO.Components.extend("_base", "_base", {
	 properties: [
     {
        key: "display_header",
        inputtype: SectionInput,
...
WEO.Components.extend("_base", "html/heading", {
...
WEO.Components.extend("_base", "html/link", {
    nodes: ["a"],
    name: "Link",
...
WEO.Components.extend("_base", "html/image", {
    nodes: ["img"],
    name: "Image",
    html: '<img src="' +  WEO.baseUrl + 'icons/image.svg" height="128" width="128">',
    /*
...
//         data: {text:"add products", icon:"la-plus"},
...
//     }]
// });
WEO.Components.add("html/hr", {
    image: "icons/hr.svg",
    nodes: ["hr"],
    name: "Horizontal Rule",
    html: "<hr>"
});
WEO.Components.extend("_base", "html/label", {
    name: "Label",
    nodes: ["label"],
...
WEO.Components.extend("_base", "html/button", {
...
WEO.Components.extend("_base", "html/jumbotron", {
    classes: ["jumbotron"],
...
WEO.Components.extend("_base", "html/textinput", {
    name: "Input",
	nodes: ["input"],
...
WEO.Components.extend("_base", "html/selectinput", {
	nodes: ["select"],
    name: "Select Input",
		...
		$(node).find('option').each(function() {
			...
			properties.push({
				...
				onChange: function(node, value, input) {
					...
					{
						option.remove();
						WEO.Components.render("html/selectinput");
						return node;
					}
...
WEO.Components.extend("_base", "html/checkbox", {
    name: "Checkbox",
...
WEO.Components.extend("_base", "html/fileinput", {
    name: "Input group",
...
WEO.Components.extend("_base", "html/video", {
    nodes: ["video"],
    name: "Video",
    ...
    dragHtml: '<img  width="320" height="240" src="' + WEO.baseUrl + 'icons/video.svg">',
