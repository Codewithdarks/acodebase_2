...
$(window).on("WEO.getHtml.before", function(event, doc) {
	$("[data-aos]", doc).removeClass("aos-init aos-animate");
});

$(window).on("WEO.getHtml.after", function(event, doc) {
	$("[data-aos]", doc).addClass("aos-init aos-animate");
});

//ignore aos classes for styles
WEO.Builder.ignoreClasses = WEO.Builder.ignoreClasses.concat(["aos-init", "aos-animate"]);
...
WEO.Components.extend("_base", "_base", ComponentBaseAnimateScroll);
