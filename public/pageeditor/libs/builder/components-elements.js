...
WEO.ComponentsGroup['Elements'] = [
	"elements/svg-icon"
];



WEO.Components.extend("_base","elements/svg-icon", {
    nodes: ["svg"],
    name: "Svg Icon",
    ...
    properties: [{
		...
		data: {
			url: WEO.baseUrl + "../../resources/svg/icons/{value}/index.html",
			clickElement:"li",
			insertElement:"svg",
			elements: 'Loading ...',
			options: [{
...
WEO.Components.add("elements/svg-element", {
