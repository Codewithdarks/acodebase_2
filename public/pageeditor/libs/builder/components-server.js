...
WEO.ComponentsGroup['Server Components'] = ["components/products", "components/product", "components/categories", "components/manufacturers", "components/search", "components/user", "components/product_gallery", "components/cart", "components/checkout", "components/filters", "components/product", "components/slider"];


WEO.Components.add("components/product", {
    name: "Product",
...
WEO.Components.add("components/products", {
    name: "Products",
...
WEO.Components.add("components/manufacturers", {
    name: "Manufacturers",
...
WEO.Components.add("components/categories", {
    name: "Categories",
...
WEO.Components.add("components/search", {
    name: "Search",
...
WEO.Components.add("components/user", {
    name: "User",
...
WEO.Components.add("components/product_gallery", {
...
WEO.Components.add("components/cart", {
    name: "Cart",
...
WEO.Components.add("components/checkout", {
    name: "Checkout",
...
WEO.Components.add("components/filters", {
    name: "Filters",
...
WEO.Components.add("components/slider", {
    name: "Slider",
