...
console.log("WEO.Components: ", WEO.Components)
    ...
    properties: [
        {
            ...
            afterInit: function (node, inputElement) {
                var selector = WEO.StyleManager.getSelectorForElement(node);
...
WEO.Components.extend("_base", "_base", ComponentBaseTypography);
...
WEO.Components.extend("_base", "_base", ComponentBaseSize);
...
WEO.Components.extend("_base", "_base", ComponentBaseMargin);
...
WEO.Components.extend("_base", "_base", ComponentBasePadding);
...
WEO.Components.extend("_base", "_base", ComponentDeviceVisibility);
