...
WEO.ComponentsGroup['Widgets'] = ["widgets/googlemaps", "widgets/video", "widgets/chartjs", "widgets/facebookpage", "widgets/paypal", "widgets/instagram", "widgets/twitter"/*, "widgets/facebookcomments"*/];

WEO.Components.extend("_base", "widgets/googlemaps", {
    name: "Google Maps",
    attributes: ["data-component-maps"],
    image: "icons/map.svg",
    dragHtml: '<img src="' + WEO.baseUrl + 'icons/maps.png">',
...
WEO.Components.extend("_base", "widgets/video", {
    name: "Video",
    attributes: ["data-component-video"],
    image: "icons/video.svg",
    dragHtml: '<img src="' + WEO.baseUrl + 'icons/video.svg" width="100" height="100">', //use image for drag and swap with iframe on drop for drag performance
...
WEO.Components.extend("_base", "widgets/facebookcomments", {
    name: "Facebook Comments",
    attributes: ["data-component-facebookcomments"],
    image: "icons/facebook.svg",
    dragHtml: '<img src="' + WEO.baseUrl + 'icons/facebook.svg">',
...
WEO.Components.extend("_base", "widgets/instagram", {
    name: "Instagram",
    attributes: ["data-component-instagram"],
    image: "icons/instagram.svg",
    drophtml: '<img src="' + WEO.baseUrl + 'icons/instagram.png">',
...
WEO.Components.extend("_base", "widgets/twitter", {
    name: "Twitter",
    attributes: ["data-component-twitter"],
    image: "icons/twitter.svg",
    dragHtml: '<img src="' + WEO.baseUrl + 'icons/twitter.svg">',
...
WEO.Components.extend("_base", "widgets/paypal", {
    name: "Paypal",
...
\
				...
				<input type="hidden" name="item_name" value="WEOJs">\
...
WEO.Components.extend("_base", "widgets/facebookpage", {
    name: "Facebook Page Plugin",
    attributes: ["data-component-facebookpage"],
    image: "icons/facebook.svg",
    dropHtml: '<img src="' + WEO.baseUrl + 'icons/facebook.png">',
   ...
   onChange: function(node, input, value, component) {
	   ...
	   $("[data-fbcssmodules]", WEO.Builder.frameHead).remove();
	   $("[data-fbcssmodules]", WEO.Builder.frameBody).remove();
	   $("script[src^='https://connect.facebook.net']", WEO.Builder.frameHead).remove();
...
WEO.Components.extend("_base", "widgets/chartjs", {
    name: "Chart.js",
    attributes: ["data-component-chartjs"],
    image: "icons/chart.svg",
	dragHtml: '<img src="' + WEO.baseUrl + 'icons/chart.svg">',
