	...
	*/	
	addMutation : function(mutation) {	
		/*
			...
			this.undoIndex++;
		*/
		WEO.Builder.frameBody.trigger("WEO.undo.add");
	...
	restore : function(mutation, undo) {	
		...
		switch (mutation.type) {
			...
			case 'characterData':
			  ...
			  break;
			case 'style':
			  $("#WEOjs-styles", window.FrameDocument).html( undo ? mutation.oldValue : mutation.newValue );
			  break;
			case 'attributes':
		...
		WEO.Builder.frameBody.trigger("WEO.undo.restore");
	 },
