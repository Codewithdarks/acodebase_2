...
_
		...
		onUpload(event) {
			...
			if (this.files && this.files[0]) {
				WEO.MediaModal.showUploadLoading();
			...
			function imageIsLoaded(e) {
					...
					formData.append("mediaPath", WEO.MediaModal.mediaPath + WEO.MediaModal.currentPath);
					...
					$.ajax({
						...
						success: function (data) {
							...
							WEO.MediaModal.addFile({
								name:data,
								type:"file",
								path: 'http://'+window.location.host + "/" + data,
								size:1
							},true);
							
							WEO.MediaModal.hideUploadLoading();
